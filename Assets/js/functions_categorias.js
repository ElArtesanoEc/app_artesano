...
document.addEventListener('DOMContentLoaded', function(){
    ...
    //NUEVA CATEGORIA
    let formCategoria = document.querySelector("#formCategorias");
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celDescripcion").innerHTML = objData.data.descripcionC;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtDescripcion").value = objData.data.descripcionC;
...
function removePhoto(){
    ...
    /*let img=document.querySelector('#img');
                    img.src="../images/uploads/portada_categoria.jpg";*/
}
function openModal()
{
    rowTable = "";
