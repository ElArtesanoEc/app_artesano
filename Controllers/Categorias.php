...
class Categorias extends Controllers
{
		...
		public function Categorias()
		{
			...
			$data['page_tag']="Categorias";//se coloca como titulo en la pestaña del navegador
			$data['page_title']="CATEGORIAS <small>El ARTESANO</small>";
			$data['page_name']="categorias";
			$data['page_functions_js']="functions_categorias.js";
			$this->views->getView($this,"categorias",$data);//hace referncia a la carpeta vistas al archivo Home.php.......tambien data envia informacion a la ista
		} 
