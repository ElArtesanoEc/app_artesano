<?php 
	class Login extends Controllers{
		...
		{
			session_start();
			if (isset($_SESSION['login'])) //verifica si existe si existe lo reenviamos al dashboard
			{
		...
		public function login()
		{
			...
			$data['page_tag']="Login - El Artesano";//se coloca como titulo en la pestaña del navegador
			$data['page_title']=" - Login";
			$data['page_name']="login";
			$data['page_functions_js']="functions_login.js";
			$this->views->getView($this,"login",$data);//hace referncia a la carpeta vistas al archivo Home.php.......tambien data envia informacion a la ista
		}
				...
				if(empty($_POST['txtEmail']) || empty($_POST['txtPassword'])){
					...
					if(empty($requestUser)){
						...
						if($arrData['status'] == 1){
							...
							$arrResponse = array('status' => true, 'msg' => 'Inicio satisfactorio');
