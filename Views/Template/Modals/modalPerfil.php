            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="txtIdentificacion" name="txtIdentificacion" required="" value="<?= $_SESSION['userData']['cedula']; ?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control valid validNumber" id="txtTelefono" name="txtTelefono" value="<?= $_SESSION['userData']['num_celular']; ?>" required="" onkeypress="return controlTag(event);">
                </div>
                <div class="form-group col-md-6">
